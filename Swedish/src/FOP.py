...
TREESELECTOR = re.compile(r"(\\.|[^\+\>\~\\\ \t])\s*([\+\>\~\ \t])\s*(\D)\s*(\+)")
...
KNOWNOPTIONS = ("collapse", "csp", "document", "elemhide", "specifichide", "shide", "ehide", "ghide", 
                ...
                "redirect=google-analytics_ga.js", "redirect=google-analytics_analytics.js", "redirect=googletagservices_gpt.js", "redirect=googletagmanager_gtm.js", 
                ...
                "redirect=3x2-transparent.png", "redirect=32x32-transparent.png", "1p", "3p", "strict1p", "strict3p", "frame", "inline-script", "xhr", "mp4", "empty", "all", 
